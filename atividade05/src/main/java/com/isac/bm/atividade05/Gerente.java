...
public class Gerente extends Funcionario{
    ...
    public void calcularBonificacao(){
        float bonificacao = getSalario() * 0.2f;
        System.out.printf("Olá Sr(a) gerente %s, seja muito bem-vindo(a) ao sistema! \n", getNome());
        System.out.printf("Seu salário atual é de %.2f \n", getSalario());
        System.out.printf("Com a bonificação de %.2f o sálario será de: %.2f  !\n",bonificacao, (getSalario() + bonificacao));
    }
}
